 ...
 */
typedef union si470x_rds_blockb_u
{
    struct
    {
...
typedef union
{
    ...
    uint8_t raw[6];
} si470x_rds_date_time_t;

/**
 * @ingroup GA01
 * @brief Converts 16 bits word to two bytes
 */
typedef union word16_to_bytes_u
{
    struct
    {
        uint8_t lowByte;
...
typedef struct
{
    ...
    si470x_reg00_t *reg00;
    si470x_reg01_t *reg01;
    si470x_reg02_t *reg02;
    si470x_reg03_t *reg03;
    si470x_reg04_t *reg04;
    si470x_reg05_t *reg05;
    si470x_reg06_t *reg06;
    si470x_reg07_t *reg07;
    si470x_reg08_t *reg08;
